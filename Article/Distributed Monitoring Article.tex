...
Since linear functions are additive and convex, the basic algorithm for distributively monitoring their value is fairly easy. A work about linear functions such as the discributed count problem was done at \cite{keralapura2006communication}. Though, things get more sophisticated when dealing with non-linear functions, where novel approaches had to be developed.

***** Should I add something here???? *****
\subsection{The Covering Spheres Method}

\subsection{The Convex Decomposition Approach}
